                  ...
                  <div>
                    <div className="foot2_thirdcolumnadress">
                      <ul className="footer2-list">
                        <li>
                          <Link to="/mentor/homepage">Home</Link>
                        </li>
                        <li>
                          <Link to="/mentor/viewtutorials">Tutorials</Link>
                        </li>
                        <li>
                          <Link to="/mentor/viewsubscribers">Chats</Link>
                        </li>
                        <li>
                          <Link to="/mentor/viewblogs">Blog</Link>
                        </li>
                        <li>
                          <Link to="/mentor/updateprofile">My Profile</Link>
                        </li>
                      </ul>
                    </div>
                  </div>
