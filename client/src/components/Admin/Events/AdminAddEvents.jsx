    ...
    const [eventdata, setEventdata] = useState({
      ...
      const handleSubmit = async (e) => {
        ...
        if (!eventdata.time.trim()) {
          ...
          errors.time = "Event Time name is required";
        }
                ...
                <div className='row pt-4'>
                    <div className='col'>
                        <table>
                            <tr>
                                ...
                                <td><input className='ad_addevent_input' 
                                type='text' 
                  ...
                  <div className="text-danger errortext">{errors.title}</div>
                            ...
                            <tr>
                                ...
                                <td><input className='ad_addevent_input_date mt-3' 
                                type='date'
                                onChange={handleInputChange} 
                                name='date'
                                />
                  ...
                  <div className="text-danger errortext">{errors.date}</div>
                            ...
                            <tr>
                                ...
                                <td><input className='ad_addevent_input mt-3' 
                                type='time'
                                onChange={handleInputChange} 
                                name='time'
                                />
                  ...
                  <div className="text-danger errortext">{errors.venue}</div>
                        ...
                        <tr>
                            ...
                            <td><textarea className='ad_addevent_input_des'
                            onChange={handleInputChange} 
                            name='description'
                            />
                            {errors.description && (
