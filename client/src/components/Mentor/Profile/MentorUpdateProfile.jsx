            ...
            {imgFile && <img  className='men_profile_round mt-1 mb-5' src={imgFile} alt="profile_image" />} 
                ...
                <div class="row">
                    <div class="col-lg-6 profile-inputtag">
                        ...
                        <div className='men_updateid_div_upload'>
                          <label className='pt-3 men_updateid_label' placeholder=''>Update Demo Video link</label>
                          <label for="id_doc" class="men_updateid_upload">
                              <div class="icon">Upload</div>
                              <input id="id_doc"  type="file"  name="demo_videolink" onChange={handleFileChange}  />
                          </label>
                        </div>
                    </div>
                    <div class="col-lg-6 profile-inputtag">
                    <select className='men_update_profile_expertise'
                ...
                <option value="Fashion and Lifestyle">Fashion and Lifestyle</option>
                        ...
                        {errors.subscription_amount  && (
                            <span className="text-danger">{errors.subscription_amount}</span>
                          )}
                        
                        

                
                    <button className='men_profileupdate_btn mt-4'>Update Profile</button>
                    </div>
