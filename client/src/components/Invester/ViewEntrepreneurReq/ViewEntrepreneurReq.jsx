        ...
        <div class="col">
            <div class="ad_invaccept_profile">
                <div class="ad_invaccept_profile_pic_div">
                    <img  className='ad_invaccept_profile_pic '  alt="profile_image" />
                </div>
                    ...
                    <div class="row row-cols-1 row-cols-md-3 g-4 mb-5">
                        <div class="col">
                            <div class="invview_ent_viewsplan_profile">
                                <tr className='invview_ent_viewsplan_subhead'><th>Company Name:</th></tr>
                                <tr><td><input className='invview_ent_viewsplan_value '  type="text" /></td></tr> 
                                <tr className='invview_ent_viewsplan_subhead'><th>Is developing:</th></tr>
                                <tr><td><input className='invview_ent_viewsplan_value' type="text" /></td></tr>
                                <tr className='invview_ent_viewsplan_subhead'><th>To help:</th></tr>
                                <tr><td><input className='invview_ent_viewsplan_value' type="text" /></td></tr>
                                <tr className='invview_ent_viewsplan_subhead'><th>To solve:</th></tr>
                                <tr><td><input className='invview_ent_viewsplan_value' type="text" /></td></tr>
                                <tr className='invview_ent_viewsplan_subhead'><th>With:</th></tr>
                                <tr><td><input className='invview_ent_viewsplan_value' type="text" /></td></tr>
                        </div>
                        ...
                        <div class="col">
                            <div class="invview_ent_viewsplan_profile">
                                <tr className='invview_ent_viewsplan_subhead'><th>We compete in the growing:</th></tr>
                                <tr><td><input className='invview_ent_viewsplan_value' type="text" /></td></tr>
                                <tr className='invview_ent_viewsplan_subhead'><th>Which last year was a:</th></tr>
                                <tr><td><input className='invview_ent_viewsplan_value' type="text" /></td></tr>
                                <tr className='invview_ent_viewsplan_subhead'><th>We are similar to competitor 1:</th></tr>
                                <tr ><td><input className='invview_ent_viewsplan_value' type="text" /></td></tr>
                                <tr className='invview_ent_viewsplan_subhead'><th>Competitor 2:</th></tr>
                                <tr><td><input className='invview_ent_viewsplan_value' type="text" /></td></tr>
                                <tr className='invview_ent_viewsplan_subhead'><th>But we:</th></tr>
                                <tr><td><input className='invview_ent_viewsplan_value' type="text" /></td></tr>
                            </div>
                        ...
                        <div class="col">
                            <div class="invview_ent_viewsplan_profile">
                                <tr className='invview_ent_viewsplan_subhead'><th>Currently we have:</th></tr>
                                <tr><td><input className='invview_ent_viewsplan_value' type="text" /></td></tr>
                                <tr className='invview_ent_viewsplan_subhead'><th>We are looking for:</th></tr>
                                <tr><td><input className='invview_ent_viewsplan_value' type="text" /></td></tr>
                                <tr className='invview_ent_viewsplan_subhead'><th>To help us:</th></tr>
                                <tr><td><input className='invview_ent_viewsplan_value' type="text" /></td></tr>
