      ...
      <div className="container men_chat_con mb-5">
        <section className="men_chat_box mt-5">
          <div className="col men_chat_nav">
            ...
            <button className="men_chat_nav_btn">
              <img className="men_chat_nav_icon" src={inv_chat_search} />
            </button>
            <button className="men_chat_nav_btn">
              <img className="men_chat_nav_icon" src={inv_chat_love} />
            </button>
            <button className="men_chat_nav_btn">
              <img className="men_chat_nav_icon" src={inv_chat_bell} />
            </button>
          </div>
              ...
              <tr>
                ...
                <td className="men_chat_message_right">
                  <p className="px-3 pt-2">
                    Hai , fine Lorem Ipsum is simply dummy text of the printing
        ...
        <section>
          <div className="men_chat_foot">
            <button className="men_chat_foot_btn mx-2" onClick={importData}>
              <img className="ent_chat_nav_icon" src={inv_chat_attachment} />
            </button>
            <button className="men_chat_foot_btn">
              <img className="men_chat_nav_icon" src={inv_chat_emoji} />
            </button>
            <div className="men_chat_foot_input_div">
              <button className="men_chat_foot_mic">
                <img className="men_chat_nav_icon" src={inv_chat_mic} />
              </button>
