...
function Entprofile() {
    ...
    if (
      ...
      if (Object.keys(errors).length === 0 && formValid) {
        ...
        try {
          var response;
          response = await axiosMultipartInstance
              .post(`/editEntrepreneurById/${id}`, userDetails )
    ...
    return (
        ...
        <HomepageNavbar/>
            <div className='text-center mt-4'>
                ...
                <div >
                    {imgFile && <img  className='profile_round mt-5' src={imgFile} alt="profile_image" />}
            ...
            <form onSubmit={onSubmit}>
                <div class="row">
                    <div class="col-lg-6 profile-inputtag">
                        ...
                        ></input>{errors.company_name  && (
                            <span className="text-danger">{errors.company_name}</span>
                          )}
                        <select className='mt-4 select_industry'
                ...
                <option value="Fashion and Lifestyle">Fashion and Lifestyle</option>
                    ...
                    <div class="col-lg-6 profile-inputtag">
                        ...
                        ></input>{errors.company_description  && (
                            <span className="text-danger">{errors.company_description}</span>
                          )}
                        <input className='mt-4' 
                        type='text' 
