                    ...
                    <div className="col">
                        <div className="ent_invreqview_profile">
                            <div className="ent_invreqview_details1">
                                <table className="gfg">
                                    <tr><th className='ent_invreqview_head'>E-Mail</th></tr>
                                    <tr><td>{investorData.email}</td></tr>
                                    <tr><th className='ent_invreqview_head'>Investing Category</th></tr>
                                    <tr><td>{investorData.investing_category}</td></tr>
                                    <tr><th className='ent_invreqview_head'>Contact No</th></tr>
                                    <tr><td>{investorData.contact}</td></tr>
                                    <tr><th className='ent_invreqview_head'>Occupation</th></tr>
                                    <tr><td>{investorData.occupation}</td></tr>
                                    <tr><th className='ent_invreqview_head'>Nationality</th></tr>
                    ...
                    <div className="col">
                        <div className="ent_invreqview_profile">
                            <div className="ent_invreqview_details2">
                                <table className="gfg">
                                    <tr><th className='ent_invreqview_head'>Organization</th></tr>
                                    <tr><td>{investorData.organization}</td></tr>
                                    <tr><th className='ent_invreqview_head'>Description</th></tr>
                                    <tr><td>{investorData.description}</td></tr>
                                    <tr><th className='ent_invreqview_head'>Address</th></tr>
                                    ...
                                    <tr></tr>
                                    <tr>
                                        <button className='ent_invreqview_confirmbtn' onClick={handleConfirm}>Confirm Request</button>
                                        <button className='ent_invreqview_cancelbtn' onClick={handleCancle}>Cancel</button>
                                    </tr>
                                </table>
                            </div>
                        </div>
