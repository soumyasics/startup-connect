...
function EntRegisterEvents() {
    ...
    const handleInputChange = (e) => {
      ...
      console.log(eventregdata,"eventdata");
    ...
    const handleSubmit = async (e) => {
        ...
        if (
            ...
            eventregdata.lname &&
            eventregdata.email &&
            eventregdata.contact &&
            eventregdata.location 
        ){
          formValid = true;
        }
        ...
        if (Object.keys(errors).length === 0 && formValid) {
          ...
          formData.append("fname", eventregdata.fname);
          formData.append("lname", eventregdata.lname);
          formData.append("email", eventregdata.email);
          formData.append("contact", eventregdata.contact);
          formData.append("location", eventregdata.location);
          ...
          console.log("Data entered", eventregdata);
        }
      };
  return (
    <>
