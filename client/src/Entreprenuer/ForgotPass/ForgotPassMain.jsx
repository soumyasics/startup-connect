  ...
  return (
    <div className='container'>
      ...
      <form className='ent-forgotpass-forgotpassform'>
        <label class='ent-forgotpass-email-label'>Your Email</label>
        <input type="email" className='ent-forgotpass-email'/>
        <label class='ent-forgotpass-newpassword-label'>New Password</label>
        <input type="password" className='ent-forgotpass-newpassword'/>
        <label class='ent-forgotpass-confirmpassword-label'>Confirm Password</label>
